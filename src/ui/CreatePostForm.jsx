  ...
  return (
    <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 transform rounded-md bg-gray-800">
      ...
      >
        ...
        {currentPage === 0 && (
          <div className="flex h-full w-full items-center justify-center rounded-b-md">
            <FileUploader
        ...
        {currentPage === 1 && (
          <div className="flex h-full w-full items-center justify-center overflow-hidden rounded-b-md bg-slate-400">
            <img
        ...
        {currentPage === 2 && (
          <div className="flex h-full w-full justify-center overflow-hidden rounded-b-md">
            <img
              src={URL.createObjectURL(file)}
              alt="post"
